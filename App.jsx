...
import MathLessonStage from "./pages/MathLessonStage";
import LanguageLevels from "./pages/LanguageLevels";
import LanguageMap from "./pages/LanguageMap";
import LanguageLessonStage from "./pages/LanguageLessonStage";
import AnnualWorldGuard from "./components/AnnualWorldGuard";
    ...
    <div className="app-routes-shell">
      <AnimatePresence mode="sync">
        ...
        >
          ...
          <Route path="/math" element={<RoutePage><AnnualWorldGuard worldId="math" worldName="Mundo de Matemáticas"><MathLevels /></AnnualWorldGuard></RoutePage>} />
          <Route path="/math/:level" element={<RoutePage><AnnualWorldGuard worldId="math" worldName="Mundo de Matemáticas"><MathMap /></AnnualWorldGuard></RoutePage>} />
          <Route path="/math/:level/unit/:unitId" element={<RoutePage><AnnualWorldGuard worldId="math" worldName="Mundo de Matemáticas"><MathLessonStage stage="presentation" /></AnnualWorldGuard></RoutePage>} />
          <Route path="/math/:level/unit/:unitId/lesson" element={<RoutePage><AnnualWorldGuard worldId="math" worldName="Mundo de Matemáticas"><MathLessonStage stage="intro" /></AnnualWorldGuard></RoutePage>} />
          <Route path="/math/:level/unit/:unitId/examples" element={<RoutePage><AnnualWorldGuard worldId="math" worldName="Mundo de Matemáticas"><MathLessonStage stage="examples" /></AnnualWorldGuard></RoutePage>} />
          <Route path="/math/:level/unit/:unitId/practice" element={<RoutePage><AnnualWorldGuard worldId="math" worldName="Mundo de Matemáticas"><MathLessonStage stage="practice" /></AnnualWorldGuard></RoutePage>} />
          <Route path="/math/:level/unit/:unitId/game" element={<RoutePage><AnnualWorldGuard worldId="math" worldName="Mundo de Matemáticas"><MathLessonStage stage="game" /></AnnualWorldGuard></RoutePage>} />
          <Route path="/math/:level/unit/:unitId/quiz" element={<RoutePage><AnnualWorldGuard worldId="math" worldName="Mundo de Matemáticas"><MathLessonStage stage="quiz" /></AnnualWorldGuard></RoutePage>} />
          <Route path="/math/:level/unit/:unitId/result" element={<RoutePage><AnnualWorldGuard worldId="math" worldName="Mundo de Matemáticas"><MathLessonStage stage="result" /></AnnualWorldGuard></RoutePage>} />
          <Route path="/math/:level/unit/:unitId/reward" element={<RoutePage><AnnualWorldGuard worldId="math" worldName="Mundo de Matemáticas"><MathLessonStage stage="reward" /></AnnualWorldGuard></RoutePage>} />
          <Route path="/language" element={<RoutePage><AnnualWorldGuard worldId="language" worldName="Comunicación y Lenguaje"><LanguageLevels /></AnnualWorldGuard></RoutePage>} />
          <Route path="/language/:level" element={<RoutePage><AnnualWorldGuard worldId="language" worldName="Comunicación y Lenguaje"><LanguageMap /></AnnualWorldGuard></RoutePage>} />
          <Route path="/language/:level/unit/:unitId" element={<RoutePage><AnnualWorldGuard worldId="language" worldName="Comunicación y Lenguaje"><LanguageLessonStage stage="presentation" /></AnnualWorldGuard></RoutePage>} />
          <Route path="/language/:level/unit/:unitId/lesson" element={<RoutePage><AnnualWorldGuard worldId="language" worldName="Comunicación y Lenguaje"><LanguageLessonStage stage="intro" /></AnnualWorldGuard></RoutePage>} />
          <Route path="/language/:level/unit/:unitId/examples" element={<RoutePage><AnnualWorldGuard worldId="language" worldName="Comunicación y Lenguaje"><LanguageLessonStage stage="examples" /></AnnualWorldGuard></RoutePage>} />
          <Route path="/language/:level/unit/:unitId/practice" element={<RoutePage><AnnualWorldGuard worldId="language" worldName="Comunicación y Lenguaje"><LanguageLessonStage stage="practice" /></AnnualWorldGuard></RoutePage>} />
          <Route path="/language/:level/unit/:unitId/game" element={<RoutePage><AnnualWorldGuard worldId="language" worldName="Comunicación y Lenguaje"><LanguageLessonStage stage="game" /></AnnualWorldGuard></RoutePage>} />
          <Route path="/language/:level/unit/:unitId/quiz" element={<RoutePage><AnnualWorldGuard worldId="language" worldName="Comunicación y Lenguaje"><LanguageLessonStage stage="quiz" /></AnnualWorldGuard></RoutePage>} />
          <Route path="/language/:level/unit/:unitId/result" element={<RoutePage><AnnualWorldGuard worldId="language" worldName="Comunicación y Lenguaje"><LanguageLessonStage stage="result" /></AnnualWorldGuard></RoutePage>} />
          <Route path="/language/:level/unit/:unitId/reward" element={<RoutePage><AnnualWorldGuard worldId="language" worldName="Comunicación y Lenguaje"><LanguageLessonStage stage="reward" /></AnnualWorldGuard></RoutePage>} />
          ...
          <Route path="/explore/math" element={<RoutePage><PublicExploreFrame><PublicExploreScreen view="levels" world="math" /></PublicExploreFrame></RoutePage>} />
          <Route path="/explore/language" element={<RoutePage><PublicExploreFrame><PublicExploreScreen view="levels" world="language" /></PublicExploreFrame></RoutePage>} />
