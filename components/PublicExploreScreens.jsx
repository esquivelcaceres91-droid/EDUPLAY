...
function ExploreHome() {
  ...
  return <main className="explore-home-rich">
    ...
    <section className="explore-home-worlds">
      ...
      <button type="button" onClick={() => go("/explore/language")}><img src="/worlds/language/language-world.svg" alt="Comunicación y Lenguaje" /><b>Explorar Lenguaje <ChevronRight /></b></button>
