...
const ROUTE_PATTERN =
  /^\/(english|computer|math|language)\/(beginner|intermediate|advanced)\/unit\/(\d+)(?:\/(lesson|examples|practice|activity|game|quiz|challenge|result|reward))?\/?$/;
...
export default function LessonCooldownGuard({ children }) {
  ...
  // eslint-disable-next-line react-hooks/purity -- snapshot inicial del temporizador existente
  ...
  if (remaining <= 0) {
    // eslint-disable-next-line react-hooks/purity -- se evalúa dentro del callback asíncrono existente
