...
export default function LanguageLevels() {
  ...
  const unlocked={beginner:true,intermediate:demo||beginnerDone>=10,advanced:demo||(beginnerDone>=10&&intermediateDone>=10)};
