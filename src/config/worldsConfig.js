export const worldsConfig = [
  ...
  { id:"language", name:"Comunicación y Lenguaje", route:"/language", image:"/worlds/language/official/language-world.png", requiredPlan:"annual", available:true, theme:"language" },
