...
function ExploreMap({ world, level }) {
  ...
  const units = world === "language" ? languageLevels[safeLevel].units.map((unit)=>[unit.title,unit.subtitle,unit.image]) : CONTENT[world][safeLevel];
